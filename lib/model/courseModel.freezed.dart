...
class _$_CourseModel implements _CourseModel {
  ...
  @override
  String toString() {
    return 'CourseModel(name: $name, englishName: $englishName, credit: $credit, type: $type, design: $design, detail: $detail, semester: $semester)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, englishName, credit, type, design, detail, semester);
...
abstract class _CourseModel implements CourseModel {
  factory _CourseModel(
      ...
      required final String semester}) = _$_CourseModel;
