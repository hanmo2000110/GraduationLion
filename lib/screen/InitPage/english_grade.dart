...
class InitEnglishGradePage extends StatefulWidget {
  ...
  @override
  State<InitEnglishGradePage> createState() => _InitEnglishGradePageState();
}
...
class _InitEnglishGradePageState extends State<InitEnglishGradePage> {
  ...
  List<String> gradeList = ['EF', 'EC', 'ERC', 'EAP'];
        ...
        Expanded(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Obx(() => ListTile(
                  ...
                  tileColor: index == initPageController.englishGrade.value
                      ? AppColors.primary
                      : Colors.white,
                  textColor: index == initPageController.englishGrade.value
                      ? Colors.white
                      : Colors.black,
                ));
          },
